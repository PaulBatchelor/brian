...
_dbdistant "db/brian.db" cdbload
_ctldistant 20 "ctrl" _dbdistant cdb slist
_sqdistant 20 "seq" _dbdistant cdb slist
...
##---
_ampsdistant '1.0 0.5 0.25 0.5' gen_vals
##---

##: Finally, the padsynth wavetable is generated. 

##---
_paddistant 262144 4 p 40 _ampsdistant gen_padsynth
##---
...
##---
0.6 maytrig dup 0 _argsdistant tset
##---
...
##---
0 p 0 4 scale floor _seqdistant tget 50 62 rand floor "key" print +
##---
...
##---
0 _argsdistant tget 0 5 trand dup floor 3 p cf
##---
...
##---
2 _argsdistant tget 1.5 * 4 p / 0.1 0 _paddistant osc +
##---
